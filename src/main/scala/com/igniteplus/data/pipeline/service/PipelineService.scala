...
object PipelineService
{
  def executePipeline() : Unit = {
    ...
    val nullValueCheckClickStreamDataDf: DataFrame = filterRemoveNull(clickStreamDataDf, COLUMNS_PRIMARY_KEY_CLICKSTREAM, CLICKSTREAM_NULL_ROWS_DATASET_PATH, WRITE_FORMAT)
